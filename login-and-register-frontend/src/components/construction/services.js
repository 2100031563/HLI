  ...
  return (
    <div className="Services">
      ...
      >
        ...
        <Divider />
        <List>
          {[<Link to="/"  style={{color: "white"}}>Home</Link>, <li><Link to="/contact"  style={{color: "white"}}>Contact</Link></li>, <li><Link to="/start">health insurance policy</Link></li>].map((text, index) => (
